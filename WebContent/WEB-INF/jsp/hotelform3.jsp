...
<div class="card-header" style="background:Red">
              <h2 class="text-left my-auto font-weight-light">Update Hotel Page</h2>
            </div>
<body>
        ...
        <div class="row justify-content-center align-items-center" id="central">
          <div class="card" style="width: 35rem;">
              ...
              <div class="card-body">
                  ...
                  <form:form class="form-signin" method="POST" action="/FinalProject/updateHotel">
