...
<div class="card-header" style="background:Yellow">
              <h2 class="text-left my-auto font-weight-light">Read Offer Page</h2>
            </div>
<body>
        ...
        <div class="row justify-content-center align-items-center" id="central">
          <div class="card" style="width: 35rem;">
              ...
              <div class="card-body">
                  ...
                  <form:form class="form-signin" method="POST" action="/FinalProject/readOffer">
                  ...
                  <div class="form-label-group">
                    ...
                    <button class="btn btn-sm btn-default btn-block mt-4" type="submit"  >Read</button>
